        ...
        <form action="process.php" method="post">
          ...
          <div class="relative mt-6 ">
            ...
            <select name="session" id="session"
              class="w-full text-gray-700 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 border border-gray-300">
              <option value="Fall" class='bg-white border border-black appearance-none hover:bg-gray-100'>Fall</option>
              <option value="Spring" class='bg-white border border-black appearance-none hover:bg-gray-100'>Spring
              </option>
            </select>
          </div>
          <div class=" my-6">
